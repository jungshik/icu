...
/*  grandfathered   preferred */
    ...
    // TODO(jungshik): Treating this and redundant tags as grandfathered tags
    // is not strictly correct. For instance, redundant tags with a Unicode
    // extension (e.g. sgn-de-u-co-phonebk, zh-cmn-hans-u-co-stroke) would not
    // work correctly. Allow these tags to be followed by other subtags.
...
ultag_parse(const char* tag, int32_t tagLen, int32_t* parsedLen, UErrorCode* status) {
    ...
    *(tagBuf + tagLen) = 0;
    ...
    // TODO(jungshik): set |next| properly for mapped redundant tags.
